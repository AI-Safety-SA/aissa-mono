...
export function resolveTrackRecordTheme(value: string | null | undefined): TrackRecordTheme {
  return value === 'dark' ? 'dark' : 'light'
}

export function applyTrackRecordTheme(root: HTMLElement, theme: TrackRecordTheme) {
